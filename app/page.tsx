...
export default function Page() {
  const [state, setState] = useState<FilterPanelState>(DEFAULT_FILTERPANEL_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Filter Panel Studio" controls={controls} preview={output} /></AppShell>;
}
