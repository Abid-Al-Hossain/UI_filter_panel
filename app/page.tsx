...
export default function Page() {
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Filter Panel Studio" headerActions={headerActions} controls={controls} preview={output} /></AppShell>;
}
